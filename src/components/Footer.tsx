  ...
  return <footer className='bg-default-950/40 backdrop-blur-3xl'>
              ...
              menuOne.map((item, index) => (
                <li>
                  <a href="#" className='text-default-300 text-base transition-all hover:text-white'>
                    <i data-lucide="gaue=ge-circle" className='me-2 inline-block h-4 w-4'>
                    </i>
                    {item}
                  </a>
                </li>
        ...
        <div className='col-span-2 lg:col-span-6'>
          <div className='bg-primary/20 rounded-xl'>
            <div className='p-10'>
              ...
              <p className='text-default-200 mb-6 text-base font-medium'>Signup and Recieve the latest tips</p>
              ...
              <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                ...
                <div className='relative'>
                  ...
                  <button type="submit" disabled={state.submitting} className='hover:bg-primary-hover hover:border-primary-hover border-primary bg-promary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounded-md px-6 text-white transition-all'>Subscribe</button>
                </div>
              </form>
    ...
    <div className='border-t border-white/10 py-6'>
      <div className='md:text-start container flex h-full flex-wrap items-center justify-center gap-4 text-center md:justify-between lg:px-20'>
        ...
        <p className='text-defualt-400 text-base font-medium'>Terms Conditions & Policy</p>
      </div>
    </div>
  </footer>
}