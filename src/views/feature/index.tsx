  ...
  const features = [
    {
      ...
      description: "Start working with Solana Token by creating, deploying, airdrop, transfering and updating token",
            ...
            features.map((list, index) => (
              <div
                ...
                <div className='p-8 sm:p-10'>
                  ...
                  className='hover:bg-primary inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-6 py-2 text-white transition-all durartion-300'>
                    Use Tools
