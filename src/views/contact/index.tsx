...
export const ContactView: FC<ContactViewProps> = ({ setOpenContact }) => {
  //FORM
  const [state, handleSubmit] = useForm("mblkeraz")
  if (state.succeeded) {
    notify({
      type: "success",
            ...
            <div className='grid gap-10 lg:grid-col-2'>
              ...
              <div className='lg:ps-0 flex h-full flex-col p-10'>
                ...
                <div className='my-auto pb-6 text-center'>
                  <h4 className='mb-4 text-2xl font-bold text-white'>Send email to us for more details</h4>
                  ...
                  <div className='text-start'>
                    <form onSubmit={handleSubmit}>
                      <div className='mb-4'>
                        ...
                        <input type="email" id="email" name="email" className='border-defualt-200 block w-full rounded border-white/10 bg-transparent py-1.5 px-3 text-white/25 focus:ring-transparent' placeholder='email' />
                      </div>
                      ...
                      <textarea
                        ...
                        cols={30}
                        rows={10}
                        className='border-defualt-200 relative block w-full rounded border-white/10 bg-transparent py-1.5 px-3 text-white/25 focus:ring-transparent' placeholder='message'></textarea>
