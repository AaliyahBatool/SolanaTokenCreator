...
export const DonateView: FC<DonateViewProps> = ({ setOpenSendTransaction }) => {
  ...
  const onClick = useCallback(async () => {
    ...
    const creatorAddress = new PublicKey(
      "DnuRaWRUezf4Hku7hqoCgXB9yiWyGD6VwbWF6ZsEtmb3"
    );
    ...
    try {
      ...
      notify({
        type: "success",
        message: `You have successfully transferred the fund ${amount}`,
        txid: signature,
      });
    } catch (error: any) {
      notify({
              ...
              <div className='lg:ps-0 flex h-full flex-col p-10'>
                ...
                <div className='my-auto pb-6 text-center'>
                  ...
                  <p className='text-default-300 mx-auto mb-5 max-w-sm'>
                   You can Donate, to the creator for the tools developer
                  </p>
