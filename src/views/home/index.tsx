      ...
      <div className='px-6 py-4'>
        <div className='bg-default-950/40 rounded-2xl'>
          <div className='container'>
            <div className='p-6'>
              <div className='relative grid gird-cols-1 items-center gap-12 lg:grid-cols-2'>
                <div className='bg-primary/10 -z-1 start-0 absolute top-0 h-14 w-14 animate-[spin_10s_linear_infinitw] rounded-2xl rounded-br-none rounded-tl-none'></div>
                  ...
                  <div>
                    ...
                    <h1 className='md:text-5xl/tight my-4 max-w-lg text-4xl font-medium text-white'>Now Create Solana Token without Code</h1>
                    <p className='text-defualt-300 md:text-lg'>Launch your solana token, All in one solana token development and deployment</p>

                    <div className='new_add_css'>
                      <a onClick={() => setOpenCreateModal(true)} className='hover:bg-primary-hover pe-4 gourp mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-1 py-1 text-white transition-all duration-300'>
